...
async fn main() {
    ...
    loop{
        ...
        println!("Block validator: {}", validator);
        println!("Txs info:");
        println!("Tx nb: {}", txs.len());
        //println!("{:?}", txs[0]);
        ...
        println!("transfer: {}, deployment: {}, execution: {}", type_count.0, type_count.1, type_count.2);
        println!("Gas info:");
        println!("Gas usage: min={}, max={}, avg={}", min_gas, max_gas, avg_gas);
